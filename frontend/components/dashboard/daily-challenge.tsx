...
export function DailyChallenge() {
  ...
  return (
    <motion.section
      ...
      className="rounded-2xl border border-[#FFB800]/25 bg-[#FFB800]/[0.05] p-4"
    >
      <div className="flex items-center justify-between">
        <span className="text-[11px] font-semibold uppercase tracking-wide text-[#FFB800]">Daily challenge</span>
        <span className="rounded-full bg-[#FFB800]/15 px-2 py-0.5 text-[10px] font-medium text-[#FFB800]">+25 XP</span>
      </div>
