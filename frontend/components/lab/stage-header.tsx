    ...
    <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
      <div>
        <div className="flex items-center gap-2">
          <span className="text-[10px] font-medium uppercase tracking-[0.15em] text-amber-400">{eyebrow}</span>
          {accuracyBadge}
        </div>
    ...
    <span
      className={
        accuracy >= 70
          ...
          : accuracy > 0
            ? "rounded-full bg-amber-500/15 px-2 py-0.5 text-[10px] font-semibold text-amber-400"
