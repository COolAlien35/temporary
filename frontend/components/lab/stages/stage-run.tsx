  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <button
        ...
        className="mt-6 flex w-full items-center justify-center gap-2 rounded-full bg-primary px-4 py-3 text-sm font-semibold text-black transition-colors hover:bg-primary"
      >
