...
export function StageBuild() {
  const { algorithm, gates, addGate, removeGate, predictionLocked, goToStage, completeStage } = useLab()
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      {predictionLocked && (
        <div className="mb-4 rounded-lg border border-amber-400/30 bg-amber-400/5 px-3 py-2 text-xs text-amber-300">
          Circuit is frozen — prediction locked
        </div>
      )}
