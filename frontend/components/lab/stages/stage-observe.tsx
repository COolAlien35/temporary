        ...
        <div className="rounded-xl border border-border bg-card/60 p-5">
                ...
                <div key={state} className="flex flex-1 flex-col items-center gap-2">
                  <div className="relative flex h-full w-full items-end justify-center gap-1.5">
                    ...
                    {mismatch && subTab === "dual" && (
                      <AlertTriangle className="absolute -top-5 size-3.5 text-amber-400" />
                    )}
                  </div>
          ...
          <div className="mt-4 flex items-center gap-4 text-[11px] text-muted-foreground">
            <span className="flex items-center gap-1.5">
              <span className="size-2.5 rounded bg-amber-400" /> Actual Outcome
            </span>
            {subTab === "dual" && (
              <span className="flex items-center gap-1.5">
                  ...
                  <td className="py-2 pr-3">
                    <div className="flex items-center gap-2">
                      <div className="h-1.5 w-16 overflow-hidden rounded-full bg-secondary">
                        <div className="h-full bg-amber-400" style={{ width: `${row.probability}%` }} />
                      </div>
