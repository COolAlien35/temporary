      ...
      <div className="flex-1 overflow-y-auto px-5 py-4">
                    ...
                    {wireGates.length === 0 ? null : (
                      <div className="relative z-10 flex gap-1.5">
                        {wireGates.map((g) => (
                          <span
                            key={g.id}
                            className="flex size-5 items-center justify-center rounded border border-amber-400/40 bg-amber-400/10 text-[9px] font-semibold text-amber-400"
                          >
                            {g.gate}
                          </span>
                        ))}
        ...
        <div
          className={cn(
            ...
            predictionLocked ? "border-l-amber-400" : "border-l-muted-foreground/30",
          )}
        >
