  ...
  return (
    <aside className="flex w-full shrink-0 flex-col border-border bg-card/40 md:w-[220px] md:border-r">
      <div className="border-b border-border px-5 py-5">
        <span className="text-[10px] font-medium uppercase tracking-[0.15em] text-amber-400">Empirical Loop</span>
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="flex items-center gap-1.5">
                      ...
                      {showLockedPill && (
                        <span className="rounded-full bg-amber-400/15 px-1.5 py-0.5 text-[9px] font-medium uppercase tracking-wide text-amber-400">
                          Locked
                        </span>
                      )}
                    </span>
