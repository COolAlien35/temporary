    ...
    <div className="flex h-full flex-col rounded-xl border border-border bg-card/60">
            ...
            <div
              ...
              className={cn(
                ...
                m.from === "partner"
                  ...
                  : "ml-auto bg-amber-400/15 text-amber-200",
              )}
            >
              {m.text}
            </div>
          ...
          <div className="mt-2 flex flex-wrap gap-1.5 px-2">
            {hints.map((hint) => (
              <button
                ...
                className="rounded-full border border-border px-2.5 py-1 text-[11px] text-muted-foreground transition-colors hover:border-amber-400/40 hover:text-foreground"
              >
                {hint}
              </button>
            ))}
      ...
      <div className="flex items-center gap-2 border-t border-border px-3 py-3">
        <input
          ...
          className="flex-1 rounded-md border border-border bg-background px-3 py-1.5 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-amber-400/40"
        />
        <button
          type="button"
          onClick={handleAsk}
          className="rounded-md bg-amber-400 px-3 py-1.5 text-xs font-semibold text-black transition-colors hover:bg-amber-300"
        >
          Ask
        </button>
      </div>
